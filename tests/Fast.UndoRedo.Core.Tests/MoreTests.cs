...
namespace Fast.UndoRedo.Core.Tests
{
    ...
    public class MoreTests
    {
        ...
        /// </summary>
        [Fact]
        public void UndoRedoServiceNoThrowOnEmptyUndoRedo()
        {
        ...
        /// </summary>
        [Fact]
        public void UndoRedoServiceClearClearsStacks()
        {
            var svc = new UndoRedoService();
        ...
        /// </summary>
        [Fact]
        public void SubscribeObserverReceivesInitialAndUpdates()
        {
            var svc = new UndoRedoService();
            int updateCount = 0;
        ...
        /// </summary>
        [Fact]
        public void RegistrationTrackerUnregisterStopsRecording()
        {
            var svc = new UndoRedoService();
        ...
        /// </summary>
        [Fact]
        public void RegistrationTrackerNestedRegistrationRecordsNestedChanges()
        {
            var svc = new UndoRedoService();
            var tracker = new RegistrationTracker(svc);
        ...
        /// </summary>
        [Fact]
        public void ReactiveAdapterUnregisterRemovesSubscriptions()
        {
            var svc = new UndoRedoService();
        ...
        /// </summary>
        [Fact]
        public void CoreObserverWrapperOnNextInvokesActionAndIgnoresExceptions()
        {
            int called = 0;
            var wrapper = new CoreObserverWrapper<string>(o =>
            {
                called++;
                if (o is string s && s == "boom")
                {
